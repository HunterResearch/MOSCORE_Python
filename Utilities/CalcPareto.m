function [myprob] = CalcPareto(myprob)
% INPUTS:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [myprob(:).pareto]=frontCell{:}; % add the pareto field to the myprob structure
    ...
    paretonum = 0;
    for i=1:numsys
        if myprob(i).pareto == 1
            paretonum = paretonum+1;
            myprob(i).pareto = paretonum;
        end
    end
    % Now sort the structure array by the index, num
    [myprob] = nestedSortStruct(myprob,'num');